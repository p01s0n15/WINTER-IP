...
def main(pdb_file, mol2_file):
    ...
    ligand_code = mol2_file.split('.')[0]  # Assuming ligand name is the file name without extension
    ...
    # Run the pipeline script with extracted information
    command = ["python3", "cute_meow_proba.py", pdb_file, mol2_file, smiles, ligand_code]
